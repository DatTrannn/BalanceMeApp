...
import com.nutrition.balanceme.BalanceMeApplication
import com.nutrition.balanceme.data.models.Credentials
import com.nutrition.balanceme.domain.usecases.AuthUseCases
import com.nutrition.balanceme.util.Result
import com.nutrition.balanceme.util.parse
import com.nutrition.balanceme.work.ItemWorker
import com.nutrition.balanceme.work.RecipesWorker
...
class AuthViewmodel @Inject constructor(private val authUseCases: AuthUseCases) : ViewModel() {
    ...
    fun startWork() {
        val manager = WorkManager.getInstance(BalanceMeApplication.appContext)
